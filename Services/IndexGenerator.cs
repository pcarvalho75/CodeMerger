...
namespace CodeMerger.Services
{
    ...
    {
        public WorkspaceAnalysis BuildWorkspaceAnalysis(string workspaceName, List<FileAnalysis> files, List<Chunk> chunks)
        {
        ...
        public string GenerateMasterIndex(WorkspaceAnalysis analysis)
        {
            var sb = new StringBuilder();

            // Workspace Overview
            sb.AppendLine($"=== WORKSPACE: {analysis.WorkspaceName} ===");
